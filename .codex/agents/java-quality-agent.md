...
```json
{
    ...
    "standards_checked": ["java-null-safety", "logging-standards", "java-lombok-patterns"],
    "recommendations": ["Add @NullMarked to package-info.java", "Replace SLF4J with CuiLogger"]
}
```
