...
public class ApiKeyAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String traceId = Optional.ofNullable(request.getHeader(ApiHeaders.TRACE_ID)).orElse(UUID.randomUUID().toString());
        response.setHeader(ApiHeaders.TRACE_ID, traceId);
        try {
            ApiRequestContext context = apiKeyAuthenticator.authenticate(
    ...
    private void writeUnauthorizedResponse(HttpServletResponse response, String traceId, String message) throws IOException {
